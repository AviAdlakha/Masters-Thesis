// Code to generate firing pattern data
...
for avi = 1:25
    ...
    clearvars -except avi
    
    bc = ['cd ''D:\Computational model of OB\your\path\here\OBGAMMA\data',num2str(avi),'''']; //change path
    eval(bc);
load Odor;
...
% fP
% fG
FileName = ['D:\Computational model of OB\KO\Cineole\OBGAMMA\Results for KO Cin 04\Firing rates',num2str(avi),'.mat'];
save(FileName, 'FM', 'FG', 'FP')
